...
<div style="float:left">
		<PublishingWebControls:RichImageField FieldName="OD2_PlayerImage" runat="server"/>
</div>
		
		<div class="hockeyLabel">
				<PublishingWebControls:EditModePanel runat="server" PageDisplayMode="Display">
					Position : 
					</PublishingWebControls:EditModePanel>
				<SharePointWebControls:DropDownChoiceField runat="server" FieldName="OD2_Position"/></div>
		<div class="hockeyLabel">		
					<PublishingWebControls:EditModePanel runat="server" PageDisplayMode="Display">
				Team : 
				</PublishingWebControls:EditModePanel>
				<SharePointWebControls:TextField runat="server" FieldName="OD2_Team"/></div>
		<div class="hockeyLabel">
				<PublishingWebControls:EditModePanel runat="server" PageDisplayMode="Display">
						Shirt Number : 
				</PublishingWebControls:EditModePanel>
						<SharePointWebControls:NumberField runat="server" FieldName="OD2_Number"/>
					</div>
		<br style="clear:both" />
		<hr />
		<PublishingWebControls:RichHtmlField FieldName="OD2_PlayerDesc" HasInitialFocus="False" MinimumEditHeight="400px" runat="server"/>
